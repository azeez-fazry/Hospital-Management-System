...
//		setResizable(false);
		...
		gl_contentPane.setHorizontalGroup(
			gl_contentPane.createParallelGroup(Alignment.LEADING)
									...
									.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
										...
										.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
											...
											.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
												...
												.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
													.addGroup(gl_contentPane.createSequentialGroup()
														.addComponent(jLabel1, GroupLayout.DEFAULT_SIZE, 157, Short.MAX_VALUE)
														.addGap(89))
													.addGroup(gl_contentPane.createSequentialGroup()
				...
				.addGroup(gl_contentPane.createSequentialGroup()
					.addContainerGap()
					.addComponent(title, GroupLayout.DEFAULT_SIZE, 700, Short.MAX_VALUE)
					.addGap(560)
	...
	protected void submitButtonActionPerformed() {
		try {
			...
			String S = "insert into doctors (fname,lname,address,phone,qualification,department,fee,date,age) values('"
