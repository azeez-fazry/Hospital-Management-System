...
public class SearchNurse extends JFrame {
...
//  End of variables declaration
	...
	public SearchNurse() {
		...
		JLabel lblNewLabel_1 = new JLabelFormat("Ward Number:");
	...
	protected void searchButtonactionPerformed() {
		...
		try {
			...
			// execute sql query
			String query = "SELECT n_fname,n_lname,phone,qualification,department,ward FROM nurse WHERE n_id=" + ID;
			resultSet = statement.executeQuery(query);

			if (resultSet.next()) {
				jLabel1.setText(resultSet.getString("n_fname") + " " + resultSet.getString("n_lname"));
