...
//  End of variables declaration
	...
	public SearchStaff() {
		...
		JLabel lblNewLabel_3 = new JLabelFormat("Phone:");

		JLabel lblNewLabel_4 = new JLabelFormat("Qualification:");

		JLabel lblNewLabel_5 = new JLabelFormat("Department:");
									...
									.addGroup(gl_contentPane.createSequentialGroup()
										...
										.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
											.addGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING, false)
												...
												.addComponent(lblNewLabel_2, Alignment.LEADING, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
										...
										.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
											...
											.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING, false)
												...
												.addComponent(jLabel3, GroupLayout.DEFAULT_SIZE, 300, Short.MAX_VALUE)
												.addComponent(jLabel2, GroupLayout.DEFAULT_SIZE, 300, Short.MAX_VALUE))))
									.addGroup(gl_contentPane.createSequentialGroup()
		...
		gl_contentPane.setVerticalGroup(
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						.addComponent(jLabel1, Alignment.TRAILING, GroupLayout.PREFERRED_SIZE, 40, GroupLayout.PREFERRED_SIZE)
	...
	protected void searchButtonactionPerformed() {
		...
		try {
			...
			// execute sql query
			String query = "SELECT s_fname,s_lname,phone,qualification,department FROM staff WHERE s_id=" + ID;

			resultSet = statement.executeQuery(query);

			if (resultSet.next()) {
				jLabel1.setText(resultSet.getString("s_fname") + " " + resultSet.getString("s_lname"));
